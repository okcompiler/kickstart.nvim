...
local default_options = {
  ...
  foldmethod = 'expr', -- 'manual' | 'expr' (for treesitter-based folding)
  foldexpr = 'nvim_treesitter#foldexpr()', -- '' (for manual method) | "nvim_treesitter#foldexpr()" (for treesitter-based folding)
  foldcolumn = '0', -- show a small column on the left of the window to indeicate folds, '0' essentially turns this off
  foldtext = '', -- empty string will syntax highlight the first line of the fold, rather than all be one color
  foldlevel = 99, -- sets the minimum level of a fold that will be closed by default, 99 essentially turns this off
